<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class=" {{ Request::is('dashboard') ? 'active' : '' }}"><a class="nav-link" href="{{ url('dashboard') }}"><i class="far fa-square"></i> <span>Dashboard</span></a></li>
          {{-- <li class="nav-item dropdown">
          ...
          <li class="menu-header">Akses</li>
            @if(Auth::user()->level == 'admin')
                <li class=" {{ Request::is('access/users') ? 'active' : '' }}"><a class="nav-link" href="{{ url('access/users') }}"><i class="fas fa-user"></i> <span>Pengguna</span></a></li>
                <li class="{{ Request::is('access/masyarakats') ? 'active' : '' }}"><a class="nav-link" href="{{ url('access/masyarakats') }}"><i class="fas fa-user"></i> <span>Masyarakat</span></a></li>
            @endif
          <li class="{{ Request::is('access/pengaduan') ? 'active' : '' }}"><a class="nav-link" href="{{ url('access/pengaduan') }}"><i class="fas fa-file-alt"></i> <span>Pengaduan</span></a></li>
          {{-- <li class="nav-item dropdown">
